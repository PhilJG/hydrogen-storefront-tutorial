...
//combine your handle and GraphQL query string with a storefront query() function. This function returns a promise object, so you need to update your loader function to be async. You also need to update your loader parameters to destructure the context object. Update your loader so it includes this code.
...
//This simple query uses the $handle` variables to retrieve the data from a single product, using the handle in your URL.
